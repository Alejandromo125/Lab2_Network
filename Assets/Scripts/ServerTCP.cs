...
public class ServerTCP : SocketConnectionTCP
{
    ...
    {
        InitSocket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp, () => _localSocket.Bind(_iPEndPointlocal));
    ...
    // Complete implementation of the previously handled functions in the Utilities class
